...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final body = ListView(
      ...
      children: [
        if (widget.firstRun) ...[
          Text('Welcome to Phil\'s Brain 🧠',
              style: Theme.of(context).textTheme.headlineSmall),
          const SizedBox(height: 4),
          const Text(
              'Point the app at your Phils Library deployment — the same server and database as the Book and YT apps.'),
        ...
        TextField(
          ...
          decoration: const InputDecoration(
            ...
            helperText:
                'Only needed for Visual Scribe if the server has no OPENROUTER_API_KEY.',
            border: OutlineInputBorder(),
          ),
        ),
        ...
        Row(
          children: [
            Expanded(
                child: Text('Text size: ${(state.mdScale * 100).round()}%')),
